...
int test_ip_srcip_empty(filter_t& f) {
...
int test_ip_srcip_filter_one(filter_t& f) {
  mac_addr_t srcmac = random_mac();
  ip_addr_t srcip = random_local_ip();
  ip_addr_t dstip = random_local_ip();
  udp_port_t srcport = random_unused_port();
...
int test_ip_srcip_filter_two(filter_t& f) {
  mac_addr_t srcmac = random_mac();
  ip_addr_t srcip = random_local_ip();
  ip_addr_t dstip = random_local_ip();
  udp_port_t srcport = random_unused_port();
  ...
  for (size_t i = 0; i < 10; i++) {
    ...
    ip_addr_t srcip;
    do { srcip = random_local_ip(); } while (memcmp(&srcip, &f.srcIPList[0], sizeof(ip_addr_t)) == 0 ||
                                             memcmp(&srcip, &f.srcIPList[1], sizeof(ip_addr_t)) == 0);
  ...
  for (size_t i = 0; i < 10; i++) {
    ...
    ip_addr_t srcip = f.srcIPList[rand() % 2];
    ip_addr_t dstip = random_local_ip();
    udp_port_t srcport = random_unused_port();
    udp_port_t dstport = random_unused_port();
    uint64_t payload = i + rand();
...
int test_ip_srcip_empty_white(filter_t& f) {
  mac_addr_t srcmac = random_mac();
  ip_addr_t srcip = random_local_ip();
  ip_addr_t dstip = random_local_ip();
  udp_port_t srcport = random_unused_port();
...
int test_ip_srcip_filter_one_white(filter_t& f) {
  mac_addr_t srcmac = random_mac();
  ip_addr_t srcip = random_local_ip();
  ip_addr_t dstip = random_local_ip();
  udp_port_t srcport = random_unused_port();
...
int test_ip_srcip_filter_two_white(filter_t& f) {
  mac_addr_t srcmac = random_mac();
  ip_addr_t srcip = random_local_ip();
  ip_addr_t dstip = random_local_ip();
  udp_port_t srcport = random_unused_port();
