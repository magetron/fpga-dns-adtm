...
connect_debug_port u_ila_0/probe0 [get_nets [list {E_TXD_OBUF[0]} {E_TXD_OBUF[1]} {E_TXD_OBUF[2]} {E_TXD_OBUF[3]}]]
...
connect_debug_port u_ila_1/clk [get_nets [list clk50_BUFG]]
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_1/probe0]
set_property port_width 8 [get_debug_ports u_ila_1/probe0]
connect_debug_port u_ila_1/probe0 [get_nets [list {sd_reg[dnsPktCnt][2]} {sd_reg[dnsPktCnt][3]} {sd_reg[dnsPktCnt][4]} {sd_reg[dnsPktCnt][5]} {sd_reg[dnsPktCnt][6]} {sd_reg[dnsPktCnt][7]} {sd_reg[dnsPktCnt][8]} {sd_reg[dnsPktCnt][9]}]]
