...
connect_debug_port u_ila_0/probe2 [get_nets [list {el_rcv_data_phy[dstPort][0]} {el_rcv_data_phy[dstPort][1]} {el_rcv_data_phy[dstPort][2]} {el_rcv_data_phy[dstPort][3]} {el_rcv_data_phy[dstPort][4]} {el_rcv_data_phy[dstPort][5]} {el_rcv_data_phy[dstPort][6]} {el_rcv_data_phy[dstPort][7]} {el_rcv_data_phy[dstPort][8]} {el_rcv_data_phy[dstPort][9]} {el_rcv_data_phy[dstPort][10]} {el_rcv_data_phy[dstPort][11]} {el_rcv_data_phy[dstPort][12]} {el_rcv_data_phy[dstPort][13]} {el_rcv_data_phy[dstPort][14]} {el_rcv_data_phy[dstPort][15]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe3]
set_property port_width 1 [get_debug_ports u_ila_0/probe3]
connect_debug_port u_ila_0/probe3 [get_nets [list el_rcv_dv_phy]]
