...
{\bf Disclaimer:}
This report is submitted as part requirement for [ANONYMOUS AUTHOR]'s BSc Computer Science degree at University College London (UCL). It is
...
Supervisors: [SUPERVISOR], [SECOND SUPERVISOR]}
...
\begin{abstract}
I would first like to express my sincerest gratitude to my supervisor [SUPERVISOR]. This project simply would not be possible without your support, guidance and sharing of your extensive experience and knowledge.

My heartfelt thanks goes to my second supervisor, [SECOND SUPERVISOR]. Thank you for all those memories during our sleepless debugging sessions. It has been an amazing experience which I had the precious opportunity of learning from a brilliant doctoral researcher. You have set an excellent example for me and motivates me to strive for the best whenever I can.
...
\includepdf[pages=-,addtotoc={1,chapter,1,Project Proposal,pdf:proposal}]{contents/appedix-proposal_redacted.pdf}
