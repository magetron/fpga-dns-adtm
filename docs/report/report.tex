...
\subsection{Hardware}
\ref{section:introduction-tools-hardware}
...
\subsection{Software}
\ref{section:introduction-tools-software}
...
\ref{section:introduction-tools-debugging}
...
As mentioned in Section \ref{section:introduction-tools-hardware}, we initially started with the Spartan 3E Starter Kit board, which was released back in 2006. 

WE NOW NEED BETTER ONES
