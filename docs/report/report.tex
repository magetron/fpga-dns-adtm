...
\subsection{Timing and Execution Pitfalls in HDL}
...
\subsection{Hardware Verification Subset vs. Hardware Description Subset}

Besides the aforementioned pitfalls, HDLs themselves 

\subsection{Signal Meta-stability}

Clock domain crossing

Driving too many signals at once

Clock fast path \& skew
