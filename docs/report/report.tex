...
This chapter rounds off the project and lays out future works that can be done potentially with a higher budget.

\section{Conclusions}
In this project, we have designed, implemented and evaluated an innovative FPGA-based system aiming that detecting DNS flood and DNS exfiltration attacks at scale and mitigating them in real-time. 
