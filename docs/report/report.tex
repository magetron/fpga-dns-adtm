...
DNS Flood attack is a type of DDoS attack, where the junk incoming traffic floods the victims the server, making it unable to provide normal service to legitimate users for a prolonged period of time \cite{cloudflare-dns-flood}. 
