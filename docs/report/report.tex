...
-- TODO:
We also provide upper level APIs to allow more complicated analysis of metrics data retrieved from FPGA to dynamically adjust the FPGA. Meaning, could be used in more complex DNS anomaly detection methods with software-based machine learning algorithms and hardware-based realtime configurable solution controlled by the software.
