...
When receiving an string input from the user, the parser will parser the string on space, and query the function pointer table with regards to which function to be called.
