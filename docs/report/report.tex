...
With the aim to provide a future proof system, we also designed and exposed Application Programming Interfaces (APIs) for more complex algorithms such as entropy-based anomaly detectors to fetch and analyse the metrics captured by the FPGA. Therefore, smarter decisions can be made in software and relevant changes can be configured on the FPGA instantaneously. 
