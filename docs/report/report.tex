...
\begin{figure}[H]
  \makebox[\textwidth][c]{\includegraphics[width=0.78\textwidth]{imgs/on-chip-impl.png}}
...
\begin{figure}[h!]
  \makebox[\textwidth][c]{\includegraphics[width=0.8\textwidth]{imgs/clock-skew.png}}
  \caption{Clock Skew graph on clock divider}
...
\subsection{Timing Pitfalls - Inferred Latches}
...
\subsection{Resource Pitfalls - FPGA Resource Constraint}
